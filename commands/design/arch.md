...
argument-hint: requirements, system description, or architecture question
scope: read-only
allowed-tools: Read, Grep, Glob, Bash
outputs: architecture design or evaluation with diagrams
accepts: requirements, system description, question
---
...
Use Mermaid diagrams for component relationships and data flow. Be opinionated — recommend a specific approach, don't just list options.
